        ...
        try {
          const data = {
            ...
            pools: pools ? pools.map((pool) => (
              {
                pool_id: pool.id,
                address_type_id: pool.pivot.address_type_id
              }
            )) : [],
          ...
          if (contact) {
            await editContact({ organisationId: organisation.id, id: contact.id, body: data });
          } else {
            await addContact({ organisationId: organisation.id, body: data });
          }
