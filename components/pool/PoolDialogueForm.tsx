...
import PoolContactsPreview from './PoolContactsPreview';
import { useAddPoolMutation, useEditPoolMutation } from '../../api/pool';
import { useRouter } from 'next/router';

interface PoolDialogueFormProps {
  pool?: Pool;
  contacts?: Contact[];
  onAddComplete?: (pool: Pool) => void;
  onEditComplete?: (pool: Pool) => void;
  onCancel?: () => void;
}

const PoolDialogueForm: FC<PoolDialogueFormProps> = (props) => {
  const {
    pool,
    contacts,
    onAddComplete,
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <PoolContactsPreview contacts={contacts} />
              </Box>
            </Grid>
            <Grid
              item
...
PoolDialogueForm.defaultProps = {
  contacts: []
};

export default PoolDialogueForm;
